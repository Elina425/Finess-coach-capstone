...
```python
from fitness_coach.pipelines.qevd_dataset_integration import QEVDDatasetLoader, DatasetPreprocessor
from fitness_coach.pipelines.model_comparison import ModelComparison
...
from fitness_coach.core.pose_estimation_core import MediaPipeDetector  # or YOLOv11Detector
