...
from fitness_coach.core.pose_estimation_core import MediaPipeDetector
from fitness_coach.pipelines.qevd_dataset_integration import DatasetPreprocessor, QEVDDatasetLoader
...
def _process_short_clip_stems(
    ...
    **apply_pipeline_kwargs: Any,
    ...
    from fitness_coach.training.build_exercise_training_index import resolve_short_clip_mp4_for_stem
...
def main() -> int:
    ...
    if args.video_path:
        ...
        try:
            from fitness_coach.training.build_exercise_training_index import (
    ...
    if args.biomechanics:
        from fitness_coach.core.biomechanical_features import batch_process_directory
