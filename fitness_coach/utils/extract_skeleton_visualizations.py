...
from fitness_coach.pipelines.run_full_comparison import visualize_model_comparison
...
def _resolve_dataset_videos(n: int, dataset_root: Path) -> list[Path]:
    try:
        from fitness_coach.pipelines.qevd_dataset_integration import QEVDDatasetLoader
